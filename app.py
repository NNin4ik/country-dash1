...
external_stylesheets = [dbc.themes.MINTY]  # Вместо FLATLY 
...
SIDEBAR_STYLE = {
    ...
    "width": "16rem",
    "padding": "2rem 1rem",
    "background-color": "#E8F8EB", # Цвет фона боковой панели 
}
...
sidebar = html.Div(
    [
        ...
        html.Hr(),
        html.P(
            "Учебный проект Нагорных Н., БСБО-14-21", className="lead"
        ),
        dbc.Nav(
            [
